...
{{- default .Values.nameOverride .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- else }}
{{- $name := default .Values.nameOverride .Values.nameOverride }}
...
*/}}
{{- define "helm-microservice.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "helm-microservice.fullname" .) .Values.serviceAccount.name }}
{{- else }}
